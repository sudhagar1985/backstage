        ...
        googlePubSubConsumingEventPublisher?: {
          ...
          subscriptions: {
            ...
            [name: string]: {
               ...
               * @remarks
               *
               * This can either be a string (sending all messages to a single
               * topic), or a more complex mapping.
               */
              targetTopic:
                | string
                | {
                    /**
                     * Reads a Pub/Sub message attribute and uses it to
                    ...
                    fromMessageAttribute: {
                      /**
                       * The name of the Pub/Sub message attribute.
                       *
                       * If the attribute is not present, the message will be acknowledged and thrown away.
                       */
                      attributeName: string;
                      /**
                       * An optional prefix to add to the topic name.
                       */
                      withPrefix?: string;
                    };
                  };
